...
# 12. 한 줄 회고
> 💰 서예찬:파인튜닝과정을 진행하며 상세한 답변을 목표로 잡고 여러가지 방법을 사용했습니다. 완성도를 높이고 싶었지만 한계가 있었고 이로인해 기대한 결과가 나오지 않은것에 많은 아쉬움이 남는것같습니다.
>
...
>
> 💰 최재동: 단순히 데이터를 만들어 학습시킨다고 무조건 성능이 나오는것은 아니라는 것을 느끼게 되었고, 학습 데이터 양 조절같이 좀 더 여러가지로 시험해볼만한 것들이 있었는데 미처 다루지 못한 부분들에 대해서는 아쉬움이 남습니다.
><br>
